...
import { StartFunc as StartFuncButtonClickFunc } from "../../../FetchFuncs/FromServer/OldOrder/2-ButtonClickFunc.js";
...
let jFLocalFromOrdersDataToItemsInOrder = () => {
    ...
    let jVarLocalFromLocalStorage = StartFuncButtonClickFunc();
