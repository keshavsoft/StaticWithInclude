let StartFunc = async () => {
    ...
    formData.append("inFolderName", "students");
    formData.append("inFileNameOnly", "gvpc");
    formData.append("inItemName", "co-ed");

    let jVarLocalUserData = {};
    jVarLocalUserData.StudentName = jVarLocalCustomerNamevalue;
    jVarLocalUserData.StudentMobile = jVarLocalCustomerNamevalue;
    jVarLocalUserData.StudentName = jVarLocalCustomerNamevalue;

    formData.append("UserData", JSON.stringify(jVarLocalUserData));
...
let StartFunc_Keshav_15Dec2023 = async () => {
    ...
    formData.append("inFileNameOnly", "gvpc");
    formData.append("inItemName", "co-ed");
    formData.append("StudentName", jVarLocalCustomerNamevalue);
    formData.append("StudentMobile", jVarLocalCustomerMobileIdvalue);
    formData.append('uploaded_file', jVarLocalfileUploadvalue);
    //  formData.append('image', jFLocalPrepareBlob());
